...
test("CI defines the responsive visual smoke matrix", () => {
  ...
  ["composer.html", "beta-lab.html", "leverage-lab.html", "financing-lab.html", "risk-lab.html", "sensitivity.html", "methodology.html", "audit.html", "strategies.html"].forEach((page) => assert.match(smoke, new RegExp(page.replace(".", "\\."))));
